...
/** Press-and-hold jump for touch play in walk mode (there's no Space key on a phone); `down` makes it
 *  the descend button shown while flying (there's no Shift key either). Reports
...
export function WalkJumpButton({ onChange, down = false }: { onChange: (held: boolean) => void; down?: boolean }) {
